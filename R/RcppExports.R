...
lanczos <- function(a, b, tol = 0, iter = 0L, orthogonalise = TRUE) {
    .Call('_sanic_lanczos', PACKAGE = 'sanic', a, b, tol, iter, orthogonalise)
}

arnoldi <- function(a, b, tol = 0, iter = 0L, symmetric = FALSE) {
    .Call('_sanic_arnoldi', PACKAGE = 'sanic', a, b, tol, iter, symmetric)
}

hessenberg <- function(a) {
    .Call('_sanic_hessenberg', PACKAGE = 'sanic', a)
}

tridiagonal <- function(a) {
    .Call('_sanic_tridiagonal', PACKAGE = 'sanic', a)
}
